...
This directory contains the lightweight reproduction code and result files for the Deng DDI event prediction experiment.
...
The processed data, molecular embeddings, and checkpoints are not included in this lightweight repository due to file size considerations. The full reproduction package is available upon reasonable request.
...
- S1-Fused All: ACC `0.9314`, F1 `0.8405`, Rec `0.8196`, Pre `0.8829`
- S2-Fused All: ACC `0.9315`, F1 `0.8401`, Rec `0.8189`, Pre `0.8829`
- S2-Fused Rare: ACC `0.6154`, F1 `0.6656`, Rec `0.6383`, Pre `0.7435`
